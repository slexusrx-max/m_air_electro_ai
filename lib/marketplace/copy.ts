  ...
  return {
    ...
    supplierNote:
      t["affiliate.active"] === "true"
        ? ro
          ? "M Air este independent. Unele legături marcate sunt afiliate: achizițiile eligibile pot genera un comision. Furnizorul stabilește prețul, stocul, plata, livrarea, garanția și retururile."
          : "M Air is independent. Some marked links are affiliate links: qualifying purchases may generate a commission. The supplier controls price, stock, payment, delivery, warranty and returns."
        : ro
          ? "M Air este un ghid independent. Legăturile către Renogy EU sunt legături obișnuite către furnizor, fără urmărire afiliată. Furnizorul stabilește prețul, stocul, plata, livrarea, garanția și retururile."
          : "M Air is an independent guide. Renogy EU links are ordinary supplier links without affiliate tracking. The supplier controls price, stock, payment, delivery, warranty and returns.",
    price: ro
