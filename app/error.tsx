...
export default function ErrorPage({ error, unstable_retry }: ErrorPageProps) {
  return (
    <div className="min-h-screen bg-[#07101d] px-4 py-10 text-white sm:px-6 lg:px-8">
      <div className="mx-auto max-w-3xl rounded-[2rem] border border-white/16 bg-[linear-gradient(180deg,rgba(255,255,255,0.12),rgba(255,255,255,0.04)),linear-gradient(180deg,rgba(7,16,29,0.62),rgba(7,16,29,0.26))] p-8 shadow-[0_24px_80px_rgba(0,0,0,0.24)] backdrop-blur-2xl">
        <p className="text-xs font-semibold uppercase tracking-[0.32em] text-amber-100/78">Application error</p>
        <h1 className="mt-4 text-4xl font-semibold tracking-tight text-white sm:text-5xl">
          Something failed before the page finished rendering.
        </h1>
        <p className="mt-5 text-base leading-8 text-white/76 sm:text-lg">
          Retry the route or head back to the main product surface. If the problem repeats, review
          the build output and runtime configuration.
        </p>
