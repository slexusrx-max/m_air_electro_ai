...
export async function POST(request: Request) {
  ...
  const system = body?.locale === "uk"
    ? "Ти M Air Electro AI — помічник з енергетики та електротехніки. Відповідай українською. Не вигадуй дані з документів, не давай інструкцій для робіт під напругою, обходу захистів або зворотного живлення генератора. Чітко позначай, коли потрібен кваліфікований електрик."
    : "You are M Air Electro AI, an energy and electrical engineering assistant. Reply in English. Do not invent document data or give instructions for energized work, bypassing protections, or generator backfeeding. Clearly state when a qualified electrician is required.";
