...
const initialForm: FormState = { application: "Home", load: "1200", peakLoad: "1800", hours: "4", region: "RO", budget: "", solar: "no", battery: "no", generator: "no", installation: "fixed" };
