...
// Keyless public demo style. Production may override this via NEXT_PUBLIC_MAP_STYLE_URL.
...
export function PowerMap({ plants }: { plants: PowerPlant[] }) {
  ...
  const selectPlant = useCallback((plant: PowerPlant) => setSelected(plant), []); const styleUrl = process.env.NEXT_PUBLIC_MAP_STYLE_URL ?? demoMapStyleUrl;
