...
export interface PowerFilters { statuses?: PowerPlantStatus[]; sources?: EnergySource[]; countries?: string[]; regions?: string[]; capacity?: "any" | "under-100" | "100-500" | "500-1000" | "over-1000"; confidence?: DataConfidence[] }
